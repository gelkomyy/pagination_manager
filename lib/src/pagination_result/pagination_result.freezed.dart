...
mixin _$PaginationResult<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<T> items) success,
    required TResult Function(String message) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<T> items)? success,
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$PaginationResultCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(final List<T> items) : _items = items;
  ...
  @override
  String toString() {
    return 'PaginationResult<$T>.success(items: $items)';
  }
...
abstract class Success<T> implements PaginationResult<T> {
  const factory Success(final List<T> items) = _$SuccessImpl<T>;
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$PaginationResultCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'PaginationResult<$T>.failure(message: $message)';
  }
...
abstract class Failure<T> implements PaginationResult<T> {
